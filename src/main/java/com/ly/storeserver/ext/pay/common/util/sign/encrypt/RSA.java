...
public class RSA {
     ...
     * @return 签名值
     */
    public static String sign(String content, String key, String characterEncoding) {
        return sign(content, key, SIGN_ALGORITHMS, characterEncoding);
    }
     ...
     * @return 签名值
     */
    public static String sign(String content, String key, String signAlgorithms, String characterEncoding) {
        try {
